...
import { Film, Lock, Mail, User as UserIcon, Sparkles } from 'lucide-react';
    ...
    <div className="max-w-md mx-auto px-4 py-16">
      <div className="glass p-8 rounded-3xl border border-white/10 shadow-2xl space-y-6">
        <div className="text-center space-y-2">
          <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-primary-500 to-accent-pink mx-auto flex items-center justify-center shadow-lg shadow-primary-500/40">
            <Sparkles className="w-6 h-6 text-white" />
          </div>
          <h1 className="text-2xl font-extrabold text-white">Join K-Flix</h1>
          <p className="text-xs text-slate-400">Create your account to start building your watchlist</p>
        </div>
